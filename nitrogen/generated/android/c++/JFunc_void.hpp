...
namespace margelo::nitro::spotlight {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/spotlight/Func_void;";
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/spotlight/Func_void_cxx;";
