...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::spotlight::Rect> final {
    static inline margelo::nitro::spotlight::Rect fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::spotlight::Rect(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::spotlight::Rect& arg) {
